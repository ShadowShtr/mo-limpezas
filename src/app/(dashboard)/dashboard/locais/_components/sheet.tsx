...
import { useState, cloneElement, isValidElement, useRef, useEffect, useTransition } from "react";
...
export function LocalSheet({ trigger, companyId, clientes, local }: Props) {
  ...
  async function handleSubmit(e: React.SyntheticEvent<HTMLFormElement>) {
    ...
    // Para novo local: aceita morada composta (campos estruturados) ou o texto da pesquisa
  ...
  if (!open) return <>{triggerWithOpen}</>;
