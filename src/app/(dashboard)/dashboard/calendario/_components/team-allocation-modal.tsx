...
import { X, Loader2, Car, RefreshCw, ChevronDown, User } from "lucide-react";
...
export function TeamAllocationModal({
  ...
  async function fetchData() {
    ...
    // Carregar alocações existentes para o dia
    try {
      const existingAllocations: VehicleAllocation[] = await getAllocationsForDate(dateStr);
