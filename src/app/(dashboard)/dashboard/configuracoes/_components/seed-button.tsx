...
export function SeedButton() {
  ...
  async function handleSeed() {
    if (!confirm("Isto vai criar dados fictícios em todas as secções (colaboradores, clientes, contratos, serviços, faturas, folha de pagamento, tarefas, viaturas…). Continuar?")) return;
    setLoading(true);
    setResult(null);
    try {
