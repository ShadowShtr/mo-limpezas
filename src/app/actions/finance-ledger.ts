...
const PAYMENT_COLUMNS = "id, kind, description, amount, due_date, status, period_year, period_month, paid_at, direct_debit, notes, sort_order, expense_category_id, created_at, updated_at, expense_categories(name)";
