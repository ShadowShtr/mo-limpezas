  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Insert: { id?: string; company_id: string; auth_user_id?: string | null; must_change_password?: boolean; full_name: string; email?: string | null; phone?: string | null; role?: string; status?: string; skills?: string[]; contracted_hours_month?: number | null; avatar_url?: string | null };
