  ...
  public: {
    Tables: {
      ...
      services: {
        ...
        Update: { team_id?: string | null; status?: string; scheduled_start?: string; scheduled_end?: string; actual_start?: string | null; actual_end?: string | null; notes?: string | null; hourly_rate?: number | null; calculated_value?: number | null; cleaning_type?: string | null; payment_status?: string | null; paid_amount?: number | null; paid_at?: string | null; upholstery_type?: string | null; upholstery_notes?: string | null; upholstery_units?: number | null; upholstery_unit_price?: number | null; apply_vat?: boolean; num_people?: number; manual_value?: number | null; discount_pct?: number; is_exception?: boolean; cancel_type?: string | null; cancel_reason?: string | null; cancelled_at?: string | null; cancelled_by?: string | null; is_late_cancel?: boolean; created_by?: string | null };
        Relationships: [];
      };
