...
export type Database = {
  public: {
    Tables: {
      ...
      contracts: {
        Row: { id: string; company_id: string; location_id: string; name: string | null; frequency: string; interval_days: number; weekdays: number[] | null; month_day: number | null; month_week: number | null; month_weekday: number | null; schedule_days: ScheduleDay[]; starts_on: string; ends_on: string | null; status: string; notes: string | null; cleaning_type: string | null; payment_status: string | null; upholstery_type: string | null; upholstery_notes: string | null; created_by: string | null; created_at: string; updated_at: string };
        Insert: { company_id: string; location_id: string; frequency: string; schedule_days: ScheduleDay[]; starts_on: string; name?: string | null; interval_days?: number; weekdays?: number[] | null; month_day?: number | null; ends_on?: string | null; status?: string; notes?: string | null; cleaning_type?: string | null; payment_status?: string | null; upholstery_type?: string | null; upholstery_notes?: string | null; created_by?: string | null };
        Update: { location_id?: string; name?: string | null; frequency?: string; interval_days?: number; weekdays?: number[] | null; schedule_days?: ScheduleDay[]; starts_on?: string; ends_on?: string | null; status?: string; notes?: string | null; cleaning_type?: string | null; payment_status?: string | null; upholstery_type?: string | null; upholstery_notes?: string | null };
        Relationships: [];
      };
      services: {
        Row: { id: string; company_id: string; location_id: string; team_id: string | null; contract_id: string | null; reference_number: string; scheduled_start: string; scheduled_end: string; hourly_rate: number | null; calculated_value: number | null; manual_value: number | null; discount_pct: number; status: string; actual_start: string | null; actual_end: string | null; is_exception: boolean; original_date: string | null; notes: string | null; cleaning_type: string | null; payment_status: string | null; upholstery_type: string | null; upholstery_notes: string | null; cancel_type: string | null; cancel_reason: string | null; cancelled_at: string | null; cancelled_by: string | null; is_late_cancel: boolean; created_by: string | null; created_at: string; updated_at: string };
        Insert: { company_id: string; location_id: string; reference_number: string; scheduled_start: string; scheduled_end: string; team_id?: string | null; contract_id?: string | null; hourly_rate?: number | null; calculated_value?: number | null; manual_value?: number | null; discount_pct?: number; status?: string; is_exception?: boolean; original_date?: string | null; notes?: string | null; cleaning_type?: string | null; payment_status?: string | null; upholstery_type?: string | null; upholstery_notes?: string | null; created_by?: string | null };
        Update: { team_id?: string | null; status?: string; scheduled_start?: string; scheduled_end?: string; actual_start?: string | null; actual_end?: string | null; notes?: string | null; cleaning_type?: string | null; payment_status?: string | null; upholstery_type?: string | null; upholstery_notes?: string | null; manual_value?: number | null; discount_pct?: number; cancel_type?: string | null; cancel_reason?: string | null; cancelled_at?: string | null; cancelled_by?: string | null; is_late_cancel?: boolean };
        Relationships: [];
      };
