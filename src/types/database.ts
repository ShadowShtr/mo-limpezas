...
export type Database = {
  public: {
    Tables: {
      ...
      company_settings: {
        Row: { id: string; company_id: string; hourly_rate: number; default_base_salary_monthly: number | null; meal_allowance_day: number; overtime_rate_pct: number; vacation_days_year: number; vat_rate: number; invoice_prefix: string; gps_radius_meters: number; timezone: string; primary_color: string; currency: string; checkin_before_minutes: number; checkout_after_minutes: number; kanban_columns: Array<{ id: string; name: string; color: string }> | null; created_at: string; updated_at: string };
        Insert: { company_id: string; hourly_rate?: number; default_base_salary_monthly?: number | null; meal_allowance_day?: number; overtime_rate_pct?: number; vacation_days_year?: number; vat_rate?: number; invoice_prefix?: string; gps_radius_meters?: number; timezone?: string; primary_color?: string; currency?: string; checkin_before_minutes?: number; checkout_after_minutes?: number; kanban_columns?: Array<{ id: string; name: string; color: string }> | null };
        Update: { hourly_rate?: number; default_base_salary_monthly?: number | null; meal_allowance_day?: number; overtime_rate_pct?: number; vacation_days_year?: number; vat_rate?: number; invoice_prefix?: string; gps_radius_meters?: number; timezone?: string; primary_color?: string; currency?: string; checkin_before_minutes?: number; checkout_after_minutes?: number; kanban_columns?: Array<{ id: string; name: string; color: string }> | null };
        Relationships: [];
      };
      profiles: {
        Row: { id: string; company_id: string; auth_user_id: string | null; must_change_password: boolean; full_name: string; phone: string | null; email: string | null; nif: string | null; iban: string | null; avatar_url: string | null; role: string; contracted_hours_month: number | null; hourly_rate: number | null; base_salary_monthly: number | null; contract_start: string | null; contract_end: string | null; vacation_balance: number | null; skills: string[]; availability: Record<string, boolean>; status: string; invited_at: string | null; invite_accepted_at: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; company_id: string; auth_user_id?: string | null; must_change_password?: boolean; full_name: string; email?: string | null; phone?: string | null; nif?: string | null; iban?: string | null; hourly_rate?: number | null; base_salary_monthly?: number | null; contract_start?: string | null; contract_end?: string | null; role?: string; status?: string; skills?: string[]; contracted_hours_month?: number | null; avatar_url?: string | null };
        Update: { auth_user_id?: string | null; must_change_password?: boolean; full_name?: string; phone?: string | null; email?: string | null; nif?: string | null; iban?: string | null; hourly_rate?: number | null; base_salary_monthly?: number | null; avatar_url?: string | null; role?: string; contracted_hours_month?: number | null; contract_start?: string | null; contract_end?: string | null; vacation_balance?: number | null; skills?: string[]; availability?: Record<string, boolean>; status?: string; invited_at?: string | null; invite_accepted_at?: string | null; company_id?: string };
        Relationships: [];
      };
      clients: {
      ...
      data_history: {
        Row: { id: number; table_name: string; row_id: string; op: string; old_data: Record<string, unknown>; new_data: Record<string, unknown> | null; actor: string | null; company_id: string | null; changed_fields: string[] | null; changed_at: string };
        Insert: { table_name: string; row_id: string; op: string; old_data: Record<string, unknown>; new_data?: Record<string, unknown> | null; actor?: string | null; company_id?: string | null; changed_fields?: string[] | null };
      ...
      payroll_records: {
        Row: { id: string; company_id: string; collaborator_id: string; period_year: number; period_month: number; contracted_hours: number; worked_hours: number; overtime_hours: number; absence_hours: number; days_worked: number; hourly_rate: number; base_salary: number; gross_salary: number; meal_allowance: number; overtime_bonus: number; absence_deductions: number; other_deductions: number; other_additions: number; net_salary: number; net_salary_override: number | null; net_salary_override_reason: string | null; status: string; notes: string | null; approved_by: string | null; paid_at: string | null; created_at: string; updated_at: string };
        Insert: { company_id: string; collaborator_id: string; period_year: number; period_month: number; contracted_hours?: number; worked_hours?: number; overtime_hours?: number; absence_hours?: number; days_worked?: number; hourly_rate?: number; base_salary?: number; gross_salary?: number; meal_allowance?: number; overtime_bonus?: number; absence_deductions?: number; other_deductions?: number; other_additions?: number; net_salary?: number; net_salary_override?: number | null; net_salary_override_reason?: string | null; status?: string; notes?: string | null; approved_by?: string | null; paid_at?: string | null };
