  ...
  public: {
    Tables: {
      ...
      fixed_variable_payments: {
        ...
        Update: { description?: string; amount?: number | null; due_date?: string | null; direct_debit?: boolean | null; status?: "pago" | "pendente"; recurring?: boolean; notes?: string | null; sort_order?: number; paid_at?: string | null; period_year?: number; period_month?: number; updated_at?: string; attachment_url?: string | null; attachment_name?: string | null; attachment_size?: number | null; attachment_mime?: string | null };
        Relationships: [];
      };
