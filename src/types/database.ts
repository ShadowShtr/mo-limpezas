  ...
  public: {
    Tables: {
      ...
      profiles: {
        ...
        Insert: { id?: string; company_id: string; auth_user_id?: string | null; must_change_password?: boolean; full_name: string; email?: string | null; phone?: string | null; nif?: string | null; iban?: string | null; hourly_rate?: number | null; contract_start?: string | null; contract_end?: string | null; role?: string; status?: string; skills?: string[]; contracted_hours_month?: number | null; avatar_url?: string | null };
        Update: { auth_user_id?: string | null; must_change_password?: boolean; full_name?: string; phone?: string | null; email?: string | null; nif?: string | null; iban?: string | null; hourly_rate?: number | null; avatar_url?: string | null; role?: string; contracted_hours_month?: number | null; contract_start?: string | null; contract_end?: string | null; vacation_balance?: number | null; skills?: string[]; availability?: Record<string, boolean>; status?: string; invited_at?: string | null; invite_accepted_at?: string | null; company_id?: string };
        Relationships: [];
      };
      clients: {
