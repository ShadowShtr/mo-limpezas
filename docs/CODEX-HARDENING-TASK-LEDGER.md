...
|---|---|---|---|---|---|
| CODEX_TASK_00 - transformar achados em provas | IN_PROGRESS | - | - | - | YES |
| CODEX_TASK_01 - invoice/cash atomicity | IN_PROGRESS | - | - | - | YES |
| CODEX_TASK_02 - invoice_items query error | IN_PROGRESS | - | - | - | YES |
