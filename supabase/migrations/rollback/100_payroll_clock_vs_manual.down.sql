-- ============================================================================
-- ROLLBACK 100 — o ponto propõe, a mão decide
-- ============================================================================
--
-- 🔴 APAGA a distinção entre «o que o ponto diz» e «o que vale». As horas
--    efectivas ficam com o valor que tinham, mas perde-se a fotografia do
--    ponto e a marca de quem as corrigiu — e, com elas, a possibilidade de
--    repor. O recálculo mensal volta a escrever por cima de correcções
--    manuais, que é exactamente o defeito que a 100 veio fechar.
--
-- As funções voltam à forma da 099.
-- ============================================================================
...
-- ─── Colunas — a perda acontece aqui ────────────────────────────────────────

ALTER TABLE public.payroll_records
  DROP COLUMN IF EXISTS hours_manual,
  DROP COLUMN IF EXISTS clock_absence_hours,
  DROP COLUMN IF EXISTS clock_days_worked,
  DROP COLUMN IF EXISTS clock_worked_hours;
